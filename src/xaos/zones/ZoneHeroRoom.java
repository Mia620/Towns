...
public class ZoneHeroRoom extends Zone implements Externalizable {
    ...
    private int ownerID = -1; // ID de h�roe, propietario de la zona
    ...
    /**
     * Asigna una zona personal libre a un h�roe. Si el h�roe YA tiene ID de
    ...
    /**
     * Asigna una zona personal CONCRETA y libre a un h�roe Si el h�roe YA tiene
    ...
    /**
     * Libera una personal hero zone, se usa si el h�roe muere o se pira, por
     * ejemplo.
     *
     * @param hero
     */
