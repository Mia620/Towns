...
public class ZoneManager {
    ...
    private static void loadXMLZones(String sXMLName, boolean bLoadingMain) {
        try {
            ...
            // Lo recorremos entero y vamos a�adiendo las zonas (ZoneManagerItem) a la hash
            ...
            Log.log(Log.LEVEL_ERROR, Messages.getString("ZoneManager.0") + " [" + e + "]", "ZoneManager"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            Game.exit();
        }
    }
