...
//		}
        ...
        // Aqu� habr� que hacer un remove del actual y un add del nuevo
...
//		}
        ...
        // Si es el �ltimo elemento lo quitamos tal cual
        if (iPosition + 1 == size()) {
        ...
        if (size() > 1) {
            // Pillamos el �ltimo y lo metemos en el hueco (Cuidado!! Usamos los m�todos de super)
            ...
            // S�lo quedaba ese elemento, lo eliminamos
    ...
    /**
     * Baja un nodo hasta su posici�n
     *
     * @param iPosition
     */
    ...
    /**
     * Sube un nodo hasta su posici�n
     *
     * @param iPosition
     */
