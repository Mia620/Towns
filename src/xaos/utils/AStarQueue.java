...
public final class AStarQueue implements Runnable {
    ...
    // N�mero de iteraciones a tratar en cada pasada del bucle principal
    ...
    /**
     * A�ade una petici�n de b�squeda de camino A*
     *
     * @param item petici�n
     */
        ...
        synchronized (requests) {
            ...
            while (i >= 0) {
                ...
                if (itemAux == null) {
                    ...
                    // Est� en la cola, borramos lo que hay
                    requests.remove(i);
                    break;
                }
            ...
            while (iIndex >= 0) {
                ...
                if (asqi != null) {
                    ...
                    if (le != null) {
                        ...
                        // Le ponemos el camino a la living y la marcamos para que no espere m�s
                        le.setPath(path);
...
//				int finished = 0;
                synchronized (requests) {
                    while (iIterations > 0 && !requests.isEmpty()) {
                        ...
                        if (item.isFinished()) {
//							finished++;
                            // B�squeda terminada, la ponemos en la cola de acabados
