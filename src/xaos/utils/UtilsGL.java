...
public final class UtilsGL {
    ...
    //
    // // Giramos los pixels pq sale al rev�s
    // int iPixel1, iPixel2;
    // for (int x = 0; x < 16; x++) {
    // for (int y = 0; y < 16; y++) {
    // iPixel1 = (y * 16 * 4) + (x * 4);
    ...
    public static ImageData loadImage(String imageFile, boolean reload) {
        ...
        try {
            // Primero miramos que no est�n en alguna carpeta de mod
    ...
    public static boolean[][] generateAlpha(boolean[][] alphaArray, int width, int height) {
        // Si llega aqu� es que es un tama�o personalizado
    ...
    /**
     * Cambia la textura Y a�ade brillo
     *
     * @param iTexture
     * @return la textura seteada
     */
