...
public class CaravanManager {
    ...
    private static void loadXMLEffects(String sXMLName, boolean bLoadingMain) {
        try {
            ...
            // Lo recorremos entero y vamos a�adiendo las caravans a la hash
            ...
            Log.log(Log.LEVEL.ERROR, Messages.getString("CaravanManager.0") + e + "]", "CaravanManager"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            Game.exit();
        }
    }
