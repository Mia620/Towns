...
//            menuTutorial.addItem(menuAux);
        ...
        if (alSavegames != null && !alSavegames.isEmpty()) {
            ...
            for (File alSavegame : alSavegames) {
                ...
                // Delete game (con su submen� de confirmaci�n)
...
//		menuOptions.addItem (menuAux);
     ...
     * despu�s deredifinir alguna tecla.
     *
     */
    ...
    public void render() {
        ...
        // Versi�n del juego abajo a la derecha
    ...
    /**
     * M�todo que se llama cuando pulse con el rat�n.
     *
        ...
        if (startingGame > 0) {
            ...
            if (mouseButton == 0) {
                if (isSettingSavegameName()) {
                    // Ha pulsado en alg�n sitio mientras el panel de savegame name est� abierto
                    ...
                    // Ha pulsado en alg�n sitio mientras el panel de hotkeys est� abierto
                    int iMousePanel = TypingPanel.whereIsMouse(x, y);
                    if (iMousePanel == UIPanel.MOUSE_TYPING_PANEL_CLOSE) {
                        // Cerramos
                    ...
                    // Ha pulsado en alg�n sitio mientras el panel de new server est� abierto
                    int iMousePanel = TypingPanel.whereIsMouse(x, y);
                    if (iMousePanel == UIPanel.MOUSE_TYPING_PANEL_CLOSE) {
                        // Cerramos
    ...
    /**
     * M�todo llamado al pulsar una tecla cuando estamos en el main menu
     *
     * @param iKey
     */
