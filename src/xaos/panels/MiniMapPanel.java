...
public final class MiniMapPanel {
    ...
    public static void render() {
        ...
        // Calculamos el tama�o del cuadrado amarillo teniendo en cuenta el tama�o del mainpanel y del minimapa
        ...
        // Lo pasamos al tama�o que toca
        iSquareX = (iSquareX * renderWidth) / World.MAP_WIDTH;
        iSquareY = (iSquareY * renderHeight) / World.MAP_HEIGHT;

        // Lo posicionamos en la pantalla (restamos tambi�n la mitad del cuadradito amarillo para que quede centrado)
    ...
    /**
     * Retorna el color a pintar de una celda seg�n el terreno y/o lo que haya
     * en ella
     *
     * @param x
     * @param y
    ...
    /**
     * Indica si el mouse est� encima del minimapa. Como se dibuja en forma de
     * diamante hacemos el c�lculo necesario
     *
     * @param x
     * @param y
     * @return
