...
//		}
    ...
    /**
     * A�ade un mensaje al final de la cola de mensajes, lo parte si no cabe
     *
     * @param iMessageType
    ...
    /**
     * A�ade un mensaje al final de la cola de mensajes Lo parte para meter en
    ...
    /**
     * A�ade el mensaje a la cola de mensajes a renderizar
     *
     * @param sMessage
     * @param color
     * @param view
    ...
    public static void render(int mouseX, int mouseY, int iMessagesType, int x, int y) {
        ...
        // Pintamos los mensajes y tambi�n miramos si el rat�n est� all� para highlightearlos
            ...
            if (i >= 0 && messagesDataRender.length > i && messagesDataRender[i] != null) {
                ...
                if (messagesDataRender[i].getView() != null || messagesDataRender[i].getEntityID() != -1) {
                    if (mouseX >= xM && mouseX < (xM + messagesDataRender[i].getWidth()) && mouseY >= yM && mouseY < (yM + UtilFont.MAX_HEIGHT)) {
                        ...
                        } else if (messagesDataRender[i].getView() != null) { // Si llega aqu� deber�a ser != null siempre
                            Game.getWorld().setView(messagesDataRender[i].getView());
                            return true;
                        }
                    }
