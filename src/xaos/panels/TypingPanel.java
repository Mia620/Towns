...
public class TypingPanel {
    ...
    /**
     * Determina donde est� el mouse y llama al render (mousePanel) Se usa, de
    ...
    /**
     * A�ade un caracter al texto y retorna true en caso de que ya haya
     * terminado.
     *
     * @param key
     * @return
    ...
    public static void setNewText(String newText) {
        ...
        // En el caso de que est� p�niendo el nombre de una partida, miraremos que no exista en disco
