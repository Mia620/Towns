...
/**
 *
 * Carga los datos de campa�as y tiene un array de campa�as
 *
 */
public class CampaignManager {
    ...
    private static void loadCampaignXML(String sXMLPath, boolean bLoadingMain) {
        try {
            ...
            // Lo recorremos entero y vamos a�adiendo los datos al array
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    // Campaign
                    // Obtenemos el ID, name y las campa�as
            ...
            Log.log(Log.LEVEL_ERROR, Messages.getString("CampaignManager.0") + " [" + e + "]", "CampaignManager"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            Game.exit();
        }
    }
