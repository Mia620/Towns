...
public class GlobalEventData implements Externalizable {
    ...
    private float green;
    private float blue;
    private int waitPCT; // Suma (multiplicaci�n) de todos los PCT activos
    private int walkSpeedPCT; // Suma (multiplicaci�n) de todos los PCT activos
    ...
    public static void setIcon() {
        ...
        // Si llega aqu� es que a�n no est� inicializado o no hay eventos, metemos el default
        icon = TILE_EVENT;
    }
