...
public class BuryData implements Externalizable {
    ...
    private int version;
    private int heightMin; // Altura m�nima
    private int height; // Altura (S�LO SE ACTUALIZA CUANDO SE GENERA EL BURY EN UN NUEVO MAPA, NO VIENE DE SERIE, YA QUE DEPENDE DE LO QUE HAYA EN EL MAPA)
                            ...
                            if (imi.isWall()) {
                                ...
                                for (int zWall = (z + 1); zWall < (World.MAP_DEPTH - 1); zWall++) {
                                    ...
                                    if (itemUnderWall == null) {
                                        ...
                                        // Si llega aqu� es que hay que crear un agujero
                                        oHash.put(Point3DShort.getPoolInstance(x, y, zWall), iEmptyInt);
                                    }
                                }
                            }
        ...
        if (Game.SAVEGAME_LOADING_VERSION >= Game.SAVEGAME_V12) {
            ...
            for (int i = 0; i < iNumPoints; i++) {
                ...
                if (sItem.equals(EMPTY) || ItemManager.getItem(sItem) != null) {
                    ...
                    // Item que no existe (quiz� porque es de un mod)
                    hash.clear();
                    hash = null;
