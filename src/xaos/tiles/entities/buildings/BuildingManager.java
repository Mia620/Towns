...
public class BuildingManager {
    ...
    private static void loadXMLBuildings(String sXMLName, boolean bLoadingMain) {
        try {
            ...
            // Lo recorremos entero y vamos a�adiendo los buildings (BuildingManagerItem) a la hash
            ...
            e.printStackTrace();
            Log.log(Log.LEVEL.ERROR, Messages.getString("BuildingManager.5") + sXMLName + Messages.getString("BuildingManager.6") + e + "]", "BuildingManager"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            Game.exit();
        }
    }
