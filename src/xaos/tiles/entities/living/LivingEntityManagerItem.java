...
public class LivingEntityManagerItem {
    ...
    // Age
    private String maxAge; // Edad m�xima del living
    ...
    public LivingEntityData getRandom() {
        // Se ponen aqu� las cosas que hay que lanzar dados, las cosas fijas no hace falta, siempre se pueden consultar de un LivingEntityManagerItem
