...
public class HeroBehaviour implements Externalizable {
     ...
     * @param behaviour   Behacviour data del h�roe, para buscar el siguiente con
     *                    PCT > 0
    ...
    public static int next(int iBehaviorID, HeroBehaviour behaviour) {
        ...
        return BEHAVIOUR_ID_NONE; // No deber�a llegar nunca
    }

    /**
     * Returna el n�mero de turnos a pasar en �ste behaviour
     *
     * @param iBehaviourID ID del behaviour a mirar
     * @param behaviour    Datos de behaviour
     * @return el n�mero de turnos a pasar en �ste behaviour
     */
